...
public abstract class DynamicMenuAction extends AppAction implements MenuAction {
     ...
     * @param model
     */
    public DynamicMenuAction(DynamicMenuListModel model, String actionCommand, boolean considerStateOnUpdate) {
        menu = new DynamicMenu(this, model, actionCommand, considerStateOnUpdate);
