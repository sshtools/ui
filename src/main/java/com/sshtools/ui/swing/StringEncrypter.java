...
public class StringEncrypter {
    ...
    StringEncrypter(char[] passPhrase) throws Exception {
        ...
        SecretKey key = SecretKeyFactory.getInstance("PBEWithSHA1AndDESede").generateSecret(keySpec);
    ...
    public static String encryptString(String unencryptedString, char[] encryptionKey) throws Exception {
        return new StringEncrypter(encryptionKey).encrypt(unencryptedString);
    }

    public static String decryptString(String encryptedString, char[] encryptionKey) throws Exception {
