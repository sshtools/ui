...
public class SortableHeaderRenderer extends JLabel implements TableCellRenderer {
  ...
  public SortableHeaderRenderer(TableColumnModel model, boolean showSortIcons,
    ...
    this.model = model;
    //  Init
    upSortIcon = new ArrowIcon(ArrowIcon.NORTH, UIManager.getColor("controlShadow"), UIManager.getColor("Button.foreground"), UIManager
            .getColor("controlLtHighlight"));
    downSortIcon = new ArrowIcon(ArrowIcon.SOUTH, UIManager.getColor("controlShadow"), UIManager.getColor("Button.foreground"), UIManager
            .getColor("controlLtHighlight"));
