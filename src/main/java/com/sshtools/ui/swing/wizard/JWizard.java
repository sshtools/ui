...
public class JWizard extends JPanel implements WizardModelListener {
	...
	public void setMainInsets(Insets insets) {
		pageContainer.setBorder(insets == null ? null : BorderFactory
				.createEmptyBorder(insets.top, insets.left, insets.bottom,
						insets.right));
	}

	void createComponents() {
		titleBar = new FolderBar();
		titleBar.setFont(titleBar.getFont().deriveFont(Font.BOLD)
				.deriveFont((float) (titleBar.getFont().getSize() * 2)));
		...
		southPanel.add(new JSeparator(JSeparator.HORIZONTAL),
				BorderLayout.NORTH);
		southPanel.add(buttonBar, BorderLayout.SOUTH);
		errorLabel = new JLabel(new ResourceIcon(getClass(),
				"/images/error-16x16.png"));
	...
	class NextAction extends AppAction {
		...
		public NextAction() {
			...
			putValue(Action.SMALL_ICON, new ResourceIcon(NextAction.class,
					"/images/next-16x16.png"));
	...
	class PreviousAction extends AppAction {
		...
		public PreviousAction() {
			...
			putValue(Action.SMALL_ICON, new ResourceIcon(PreviousAction.class,
					"/images/previous-16x16.png"));
	...
	class FinishAction extends AppAction {
		...
		public FinishAction() {
			...
			putValue(Action.SMALL_ICON, new ResourceIcon(FinishAction.class,
					"/images/finish-16x16.png"));
	...
	class CancelAction extends AppAction {
		...
		public CancelAction() {
			...
			putValue(Action.SMALL_ICON, new ResourceIcon(CancelAction.class,
					"/images/cancel-16x16.png"));
