...
public class SwingFileSelector implements FileSelector {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sshtools.ui.FileSelector#init(int, java.io.File, boolean,
	...
	public void init(int type, File cwd, boolean showButtons,
		...
		chooser.setApproveButtonText("Ok"); // TODO FileSelect does not
											// recognise dialog type (i.e. Open
											// / Save)
		...
		if (showHiddenFilesSwitch) {
			final JCheckBox hiddenFiles = new JCheckBox("Show hidden files",
					false);
	 ...
	 * 
	 * @see
	 * com.sshtools.ui.FileSelector#addFileFilter(com.sshtools.ui.FileFilter)
	 */
	public void addFileFilter(final FileFilter filter) {
		javax.swing.filechooser.FileFilter swingFilter = new javax.swing.filechooser.FileFilter() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.sshtools.ui.FileSelector#showDialog(java.awt.Component,
	 * java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * com.sshtools.ui.FileSelector#setSelectedFileFilter(com.sshtools.ui.FileFilter
	 * )
	 */
	public void setSelectedFileFilter(FileFilter filter) {
		javax.swing.filechooser.FileFilter swingFilter = (javax.swing.filechooser.FileFilter) filters
				.get(filter);
		if (swingFilter != null) {
