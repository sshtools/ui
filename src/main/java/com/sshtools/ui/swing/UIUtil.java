...
public class UIUtil implements SwingConstants {
	 ...
	 * 
	 * @param string
	 *            string in format <code>x,y,width,height</code>
	 * @param defaultValue
	 *            default rectangle
	 * @return rectangle
	 */
	public static Rectangle stringToRectangle(String string,
		...
		try {
			return new Rectangle(Integer.parseInt(t.nextToken()),
					Integer.parseInt(t.nextToken()), Integer.parseInt(t
							.nextToken()), Integer.parseInt(t.nextToken()));
		} catch (Exception e) {
			return defaultValue;
		}
	}
	...
	public static void jGridBagAdd(JComponent parent, Component componentToAdd,
		...
		if (!(parent.getLayout() instanceof GridBagLayout)) {
			throw new IllegalArgumentException(
					Messages.getString("UIUtil.parentMustHaveAGridBagLayout")); //$NON-NLS-1$
		}
	...
	public static void positionComponent(int p, Component c, Component o) {
		...
		try {
			try {
				Object gc = c.getClass()
						.getMethod("getGraphicsConfiguration", new Class[] {})
						.invoke(c, new Object[] {});
				Object device = gc.getClass()
						.getMethod("getDevice", new Class[] {})
						.invoke(gc, new Object[] {});
				Object defaultConfig = device.getClass()
						.getMethod("getDefaultConfiguration", new Class[] {})
						.invoke(device, new Object[] {});
				d = (Rectangle) defaultConfig.getClass()
						.getMethod("getBounds", new Class[] {})
						.invoke(defaultConfig, new Object[] {});
			} catch (Throwable t) {
			}
		} catch (Throwable t) {
		}
	...
	public static Image scaleWidth(int width, Image image,
		...
		return image.getScaledInstance(width,
				(int) (image.getHeight(observer) * scale), Image.SCALE_SMOOTH);
	}

	public static Image scaleHeight(int height, Image image,
			ImageObserver observer) {
		if (image == null) {
			return null;
		}
		...
		return image.getScaledInstance(
				(int) (image.getWidth(observer) * scale), height,
				Image.SCALE_SMOOTH);
	}
	...
	public static Image getImage(Icon icon) {
		BufferedImage bim = new BufferedImage(icon.getIconWidth(),
	...
	public static void setIconImage(Dialog d, Image image) {
		try {
			d.getClass().getMethod("setIconImage", new Class[] { Image.class })
