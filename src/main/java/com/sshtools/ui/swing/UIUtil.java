    ...
    public static void positionComponent(int p, Component c, Component o) {
        ...
        try {
            try {
            	...
            	Object defaultConfig = device.getClass().getMethod("getDefaultConfiguration", new Class[] { }).invoke(device, new Object[] { });
            	d = (Rectangle)defaultConfig.getClass().getMethod("getBounds", new Class[] { }).invoke(defaultConfig, new Object[] { });
            }
            catch (Throwable t) {
            }
        } catch (Throwable t) {
