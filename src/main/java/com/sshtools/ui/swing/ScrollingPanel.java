...
public class ScrollingPanel extends JPanel implements ActionListener {
    ...
    public ScrollingPanel(JComponent component) {
        ...
        north = new JButton(new ArrowIcon(SwingConstants.NORTH, UIManager.getColor("controlShadow"), UIManager.getColor("Button.foreground"), UIManager
        ...
        south = new JButton(new ArrowIcon(SwingConstants.SOUTH, UIManager.getColor("controlShadow"), UIManager.getColor("Button.foreground"), UIManager
	            .getColor("controlLtHighlight")));
    ...
    public void actionPerformed(ActionEvent event) {
        Dimension view = new Dimension(getSize().width, getSize().height - north.getPreferredSize().height
