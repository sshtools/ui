...
public class UIUtil {
			...
			if (tracker.isErrorAny()) {
				/* DEBUG */System.err
						.println(MessageFormat.format(
								Messages.getString("UIUtil.imageDidNotLoad"), new Object[] { image.toString() })); //$NON-NLS-1$
			}
		}
	...
	public static Image loadImage(Class clazz, String resource) {
		...
		if (img == null) {
			System.err
					.println(MessageFormat.format(
							Messages.getString("UIUtil.couldNotLocateImage"), new Object[] { resource })); //$NON-NLS-1$
		}
		return img;
	}
	...
	public static void gridBagAdd(Container parent, Component componentToAdd,
		...
		if (!(parent.getLayout() instanceof GridBagLayout)) {
			throw new IllegalArgumentException(
					Messages.getString("UIUtil.parentMustHaveGridBagLayout")); //$NON-NLS-1$
		}
